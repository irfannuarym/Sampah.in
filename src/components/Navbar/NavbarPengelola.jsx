...
// export default NavbarPengelola;
...
const user = {
  ...
  email: 'irfannuarym005@gmail.com',
}
const navigation = [
  { name: 'Dashboard', href: '#', current: true },
  { name: 'Tim', href: '#', current: false },
  ...
  return (
    <>
      <div className="min-h-full">
                  ...
                  <Menu as="div" className="relative ml-3">
                    <div>
                      <MenuButton className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800">
                        ...
                        <img alt="Logo Sampah.in" src={User} className="h-12 w-auto" />
                      </MenuButton>
                    </div>
                    <MenuItems
                      transition
              ...
              <div className="mt-3 space-y-1 px-2">
                {userNavigation.map((item) => (
                  <DisclosureButton
                    ...
                    as="a"
                    href={item.href}
                    className="block rounded-md px-3 py-2 text-base font-medium text-green-600 hover:bg-green-700 hover:text-white"
                  >
                    {item.name}
                  </DisclosureButton>
                ))}
        ...
        <main>
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            Konten ini bersumber dari Pengelola.
          </div>
        </main>
      </div>
    </>
