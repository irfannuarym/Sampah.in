...
import DashboardWarga from '../../components/Warga/DashboardWarga';
import LaporSampah from '../../components/Warga/LaporSampah';
          ...
          <PopoverGroup className="hidden lg:flex lg:gap-x-6">
            <Link
              ...
              className={`flex items-center text-lg font-semibold transition px-3 py-1
                ${isActive('/dashboard/user', '') ? 'border-b-2 border-white text-white' : 'text-white hover:bg-white hover:text-green-500 hover:rounded-md'}`}
            >
              Dashboard
            </Link>
            ...
            <Link
              ...
              className={`flex items-center text-lg font-semibold transition px-3 py-1
                ${isActive('/dashboard/user', 'laporan-sampah') ? 'border-b-2 border-white text-white' : 'text-white hover:bg-white hover:text-green-500 hover:rounded-md'}`}
            >
              Lapor Sampah
            </Link>
            <div className="border-l border-white/60 h-6 self-center" />
            <Link
              ...
              className={`flex items-center text-lg font-semibold transition px-3 py-1
                ${isActive('/dashboard/user', 'jadwal-pengangkutan') ? 'border-b-2 border-white text-white' : 'text-white hover:bg-white hover:text-green-500 hover:rounded-md'}`}
            >
              Jadwal Pengangkutan
            </Link>
